...
<img src="../california_housing_prices_plot.png" alt="Working" />
...
<img src="../random_forest_feature_importance.png" alt="Working" />
3. Check whether the data is skewed or not. Because model excepts uniform data. I used log transformation.
<img src="../population_log_transformation.png" alt="Working" />
